...
Текущая скорость в махах
 ...
 - Mfuel0, kg":9400,
## MNE
Критическая скорость самолет в махах
...
## VNE, km/h
Критическая скорость самолета в км/ч
...
## wing_sweep_lever
Угол раскрытия крыльев(0..1) для самолетов с изменяемой стреловидностью крыла

## wing_sweep_indicator
Угол на который нужно раскрыться крыльям(0..1) для самолетов с изменяемой стреловидностью крыла
